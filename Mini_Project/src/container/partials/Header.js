        ...
        <div className="flex items-center justify-between h-20">         
          ...
          <nav className="md:flex md:flex-grow">
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center"> 
              ...
              <li>
                <Link to="/" className={`hover:text-gray-200 px-6 py-2 flex items-center transition duration-150 ease-in-out `}>
                  About
                </Link>
              </li>             
              <li>
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                ...
                <li>
                <div className="pr-30">
                <Link to="/signup" className="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Sign Up</Link>
                </div> 
              </li>
